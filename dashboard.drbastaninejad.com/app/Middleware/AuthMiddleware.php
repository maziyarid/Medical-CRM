 ...
 * On failure: returns a 401 JSON response immediately (null = pass through).
 */
final class AuthMiddleware
{
    public function handle(Request $req): ?array
    {
        ...
        if (!str_starts_with($header, 'Bearer ')) {
            return $this->unauthorized('توکن احراز هویت الزامی است');
        }
        ...
        if ($token['revoked_at'] !== null) {
            return $this->unauthorized('توکن لغو شده است. دوباره وارد شوید');
        }
